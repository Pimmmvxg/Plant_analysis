...
def auto_thresh_lab_a_otsu_guard(
        ...
        v_bg=45,                 # เพิ่มนิดเพื่อกันฉากดำ/มืด
        blur_ksize=3,
...
img_bgr = cv2.imread(r"R:\01-Organize\01-Management\01-Data Center\Brisk\06-AI & Machine Learning (D0340)\04-IOT_Smartfarm\picture_original_topview_smartfarm\picture_topview_05092025_162653.jpg")
img_rgb = cv2.cvtColor(img_bgr, cv2.COLOR_BGR2RGB)

# เรียกใช้ฟังก์ชัน auto
t, mask = auto_thresh_lab_a_otsu_guard(img_rgb, object_type="dark")

print("Threshold ที่ได้ =", t)
